<cfcomponent name="Mailer" hint="Sends email">
	...
	<cfif arguments.type EQ "html">
		...
		<cfif NOT len( arguments.from )>
			<cfset arguments.from = variables.defaultFromAddress />
		</cfif>

	<cfif len(variables.server)>
		<cfmail to="#arguments.to#" from="#arguments.from#" subject="#arguments.subject#" server="#variables.server#"
				username="#variables.username#" password="#variables.password#" cc="#arguments.cc#" bcc="#arguments.bcc#" replyto="#arguments.replyto#"><cfif arguments.type NEQ "html">#arguments.body#<cfelse><cfmailpart type="text">#plaintext#</cfmailpart>
	...
	<cfelse><!--- no server --->
		<cfmail to="#arguments.to#" from="#arguments.from#" subject="#arguments.subject#" cc="#arguments.cc#" bcc="#arguments.bcc#" replyto="#arguments.replyto#"><cfif arguments.type NEQ "html">#arguments.body#<cfelse><cfmailpart type="text">#plaintext#</cfmailpart>
				   <cfmailpart type="html">
				   	#arguments.body#
				  </cfmailpart>
			</cfif>
