...
ALTER TABLE #prefix#link ADD CONSTRAINT PK_#prefix#link PRIMARY KEY  ( id );
...
ALTER TABLE #prefix#link_category ADD CONSTRAINT PK_#prefix#link_category PRIMARY KEY  ( id	);
...
ALTER TABLE #prefix#author ADD CONSTRAINT PK_#prefix#author PRIMARY KEY  ( id );


ALTER TABLE #prefix#blog ADD CONSTRAINT PK_#prefix#blog PRIMARY KEY  (	id );
	
ALTER TABLE #prefix#author_blog ADD CONSTRAINT PK_#prefix#author_blog PRIMARY KEY (	
	author_id,
	blog_id
);


ALTER TABLE #prefix#category ADD CONSTRAINT PK_#prefix#category PRIMARY KEY 
	(
		id
	);

ALTER TABLE #prefix#entry ADD CONSTRAINT PK_#prefix#entry PRIMARY KEY 
	(
		id
	);

ALTER TABLE #prefix#comment ADD CONSTRAINT PK_#prefix#comment PRIMARY KEY 
	(
		id
	);

ALTER TABLE #prefix#entry_custom_field ADD CONSTRAINT PK_#prefix#entry_custom_field PRIMARY KEY 
	(
		id,
		entry_id
	);

ALTER TABLE #prefix#entry_subscription ADD CONSTRAINT PK_#prefix#subscription PRIMARY KEY  
	(
		entry_id,
		email,
		type
...
ALTER TABLE #prefix#media ADD CONSTRAINT PK_#prefix#media PRIMARY KEY  
	(
		id
	);

ALTER TABLE #prefix#page ADD CONSTRAINT PK_#prefix#page PRIMARY KEY  
	(
		id
	);


ALTER TABLE #prefix#post ADD CONSTRAINT PK_#prefix#post PRIMARY KEY  
	(
		id
	);

ALTER TABLE #prefix#trackback ADD CONSTRAINT PK_#prefix#trackback PRIMARY KEY  
	(
		id
	);

ALTER TABLE #prefix#post_category ADD CONSTRAINT PK_#prefix#post_category PRIMARY KEY 
	(
		post_id,
		category_id
	);
...
ALTER TABLE #prefix#author ADD CONSTRAINT IX_#prefix#author UNIQUE  NONCLUSTERED 
	( username );

ALTER TABLE #prefix#entry 
...
ALTER TABLE #prefix#entry_subscription 
  ALTER COLUMN mode 
    SET DEFAULT 'instant';
...
ALTER TABLE #prefix#author_blog 
  ADD FOREIGN KEY( author_id ) 
    REFERENCES #prefix#author( id ) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE #prefix#author_blog 
  ADD FOREIGN KEY( blog_id ) 
    REFERENCES #prefix#blog( id ) ON DELETE CASCADE ON UPDATE CASCADE;


ALTER TABLE #prefix#category 
  ADD CONSTRAINT FK_#prefix#category_blog 
    FOREIGN KEY ( blog_id ) 
	  REFERENCES #prefix#blog ( id );


ALTER TABLE #prefix#entry 
  ADD CONSTRAINT FK_#prefix#entry_author 
    FOREIGN KEY ( author_id ) 
	  REFERENCES #prefix#author ( id ) ON DELETE CASCADE  ON UPDATE CASCADE;

ALTER TABLE #prefix#entry 
  ADD CONSTRAINT FK_#prefix#entry_blog 
    FOREIGN KEY ( blog_id ) 
	  REFERENCES #prefix#blog ( id ) ON DELETE CASCADE  ON UPDATE CASCADE;


ALTER TABLE #prefix#comment 
  ADD CONSTRAINT FK_#prefix#comment_author 
    FOREIGN KEY ( author_id ) 
      REFERENCES #prefix#author ( id ) ON DELETE CASCADE  ON UPDATE CASCADE;

	
ALTER TABLE #prefix#comment 
  ADD CONSTRAINT FK_#prefix#comment_comment 
    FOREIGN KEY ( parent_comment_id ) 
	  REFERENCES #prefix#comment ( id ) ON DELETE CASCADE  ON UPDATE CASCADE;
	  
	
ALTER TABLE #prefix#comment 
  ADD CONSTRAINT FK_#prefix#comment_entry 
    FOREIGN KEY ( entry_id ) REFERENCES #prefix#entry ( id ) ON DELETE CASCADE  ON UPDATE CASCADE;



ALTER TABLE #prefix#entry_custom_field 
  ADD CONSTRAINT FK_#prefix#entry_custom_field_entry 
    FOREIGN KEY ( entry_id ) REFERENCES #prefix#entry ( id ) ON DELETE CASCADE  ON UPDATE CASCADE;

	
ALTER TABLE #prefix#entry_subscription 
  ADD CONSTRAINT FK_#prefix#subscription_entry 
    FOREIGN KEY ( entry_id ) REFERENCES #prefix#entry ( id ) ON DELETE CASCADE  ON UPDATE CASCADE;

	
	
ALTER TABLE #prefix#media 
  ADD CONSTRAINT FK_#prefix#media_entry 
    FOREIGN KEY ( entry_id ) 
	  REFERENCES #prefix#entry ( id ) 
	    ON DELETE CASCADE  ON UPDATE CASCADE;


ALTER TABLE #prefix#page 
  ADD CONSTRAINT FK_#prefix#page_entry 
    FOREIGN KEY ( id ) 
	  REFERENCES #prefix#entry ( id ) 
	    ON DELETE CASCADE  ON UPDATE CASCADE;
...
ALTER TABLE #prefix#post 
  ADD CONSTRAINT FK_#prefix#post_entry 
    FOREIGN KEY ( id ) 
	  REFERENCES #prefix#entry ( id ) 
	    ON DELETE CASCADE  ON UPDATE CASCADE;

	
ALTER TABLE #prefix#trackback 
  ADD CONSTRAINT FK_#prefix#trackback_entry 
    FOREIGN KEY ( entry_id ) 
      REFERENCES #prefix#entry ( id ) 
        ON DELETE CASCADE  ON UPDATE CASCADE;

	
ALTER TABLE #prefix#post_category 
  ADD CONSTRAINT FK_#prefix#post_category_category 
...
ALTER TABLE #prefix#post_category 
  ADD CONSTRAINT FK_#prefix#post_category_post 
    FOREIGN KEY ( post_id ) 
